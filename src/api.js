...
utils.module.save('api', (function(){
    ...
    var api = {
        ...
        load: { 
            ...
            groups: {
                sensor : generateRetrieveAndGroupingFct(endpoint.sensors.get   ,endpoint.groups.sensor.get),
                tag    : generateRetrieveAndGroupingFct(endpoint.tags   .get   ,endpoint.groups.tag   .get),
                user   : generateRetrieveAndGroupingFct(endpoint.users  .getAll,endpoint.groups.user  .get)
            },
            permissions: {
        ...
        alter: { 
            group: {
                add: {
                    sensor : generateAddFct(endpoint.groups.sensor.create),
                    tag    : generateAddFct(endpoint.groups.tag   .create),
                    user   : generateAddFct(endpoint.groups.user  .create)
                },
                remove: {
